...
const PLAN_PRICES = { free: '$0', creator: '$19', pro: '$49' };
    ...
    >
      ...
      {!isPaid && (
        <div className="mt-4 rounded-lg bg-primary/5 p-3 text-center">
          ...
          <button className="mt-2 rounded-lg bg-primary px-6 py-2 text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition-colors">
            View Plans
          </button>
        </div>
      )}

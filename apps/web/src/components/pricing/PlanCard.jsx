...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: '5 AI rewrites/month', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '50 AI rewrites/month', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Unlimited AI rewrites (all tones)', included: true },
      { text: 'Bulk scheduling', included: true },
      { text: 'Priority processing', included: true },
      { text: 'Advanced analytics', included: true },
      { text: 'Circles: 15 collaborators', included: true },
      { text: 'Full collaboration + publishing control', included: true },
    ],
  },
];
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        popular
          ? 'scale-[1.03] border-primary/50 ring-2 ring-primary/20 md:scale-105'
          : 'border-border'
      )}
    >
      {popular && (
